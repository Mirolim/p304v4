...
function roots_add_rewrites($content) {
  ...
  $roots_new_non_wp_rules = array(
    'css/(.*)'      => 'ins/themes/'. $theme_name . '/css/$1',
    'js/(.*)'       => 'ins/themes/'. $theme_name . '/js/$1',
    'img/(.*)'      => 'ins/themes/'. $theme_name . '/img/$1',
    'mdls/(.*)'  => 'ins/mdls/$1'
  );
...
function roots_clean_assets($content) {
  ...
  $current_path = '/ins/themes/' . $theme_name;
  $new_path = '';
...
function my_init() {
    if (!is_admin()) {
        ...
        wp_register_script('jquery','/js/jquery-1.7.2.min.js?ver=1.7.2');
