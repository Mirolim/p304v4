...
load_plugin_textdomain('ckrating', "/ins/mdls/comment-rating/");

define('COMMENTRATING_VERSION', '2.9.32');
define('COMMENTRATING_PATH', WP_CONTENT_DIR.'/mdls/'.plugin_basename(dirname(__FILE__)) );
...
{
   global $ck_cache;
   $plugin_path = get_bloginfo('wpurl').'/ins/mdls/comment-rating';
...
//      $onclick_add = "onclick=\"javascript:ckratingKarma('$ck_comment_ID', 'add', '{$ck_link}/ins/mdls/comment-rating/', '$imgIndex');\" title=\"". __('Thumb up','ckrating'). "\"";
//      $onclick_sub = "onclick=\"javascript:ckratingKarma('$ck_comment_ID', 'subtract', '{$ck_link}/ins/mdls/comment-rating/', '$imgIndex')\" title=\"". __('Thumb down', 'ckrating') ."\"";
//EP-12-31-2009 Replaced two lines above with line below for Tooltip Text option.  I think __() is the localization. We shouldn't need that for these strings now. 
      $onclick_add = "onclick=\"javascript:ckratingKarma('$ck_comment_ID', 'add', '{$ck_link}/ins/mdls/comment-rating/', '$imgIndex');\" title=\"". get_option('ckrating_up_alt_text')."\"";
      $onclick_sub = "onclick=\"javascript:ckratingKarma('$ck_comment_ID', 'subtract', '{$ck_link}/ins/mdls/comment-rating/', '$imgIndex')\" title=\"".get_option('ckrating_down_alt_text')."\"";
   }
