...
Belorrusian translation by <a href="http://www.itransition.com/">Itransition</a>  


= 2.9.31 =

Hebrew translation by <a href="http://www.techhead.co.il"> TechHead </a>


= 2.9.30 =

Hooks voting into wordpress's global action system and uses a predefined wordpress core action for comment changes. This enables caching plugins, such as W3 Total Cache, can react to comment changes. 
Thanks <a href="http://www.zx2c4.com/"> Jason Donenfeld </a> for providing the patch.


= 2.9.29 =

It took me a while to upgrade from PHP 5.1.6 to PHP 5.3.2 and
install WordPress 3.2.1.  Now Comment Rating is tested on WP 3.2.1,
