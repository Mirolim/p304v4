...
?>
   ...
   <td>
       ...
       <img src="<?php echo get_bloginfo('wpurl').'/ins/mdls/comment-rating/images/1_16_up.png'; ?>" /><img src="<?php echo get_bloginfo('wpurl').'/ins/mdls/comment-rating/images/1_16_down.png'; ?>" />
       <input type="radio" name="ckrating_image_index" value="2"
          <?php if (get_option('ckrating_image_index') == 2) echo 'checked';?> >
       <img src="<?php echo get_bloginfo('wpurl').'/ins/mdls/comment-rating/images/2_16_up.png'; ?>" /><img src="<?php echo get_bloginfo('wpurl').'/ins/mdls/comment-rating/images/2_16_down.png'; ?>" />
       <input type="radio" name="ckrating_image_index" value="3"
          <?php if (get_option('ckrating_image_index') == 3) echo 'checked';?> >
       <img src="<?php echo get_bloginfo('wpurl').'/ins/mdls/comment-rating/images/3_16_up.png'; ?>" /><img src="<?php echo get_bloginfo('wpurl').'/ins/mdls/comment-rating/images/3_16_down.png'; ?>" />
   </td>
   </tr>
   <tr>
   <td>
...
<!--Added by Eric Peterka, 12-31-2009, ToolTip Text options -->
   ...
   <td>
      <img src="<?php echo get_bloginfo('wpurl').'/ins/mdls/comment-rating/images/3_16_up.png'; ?>" />
      <input type="text" name="ckrating_up_alt_text" value="<?php echo get_option('ckrating_up_alt_text'); ?>">
      <br />
      <img src="<?php echo get_bloginfo('wpurl').'/ins/mdls/comment-rating/images/3_16_down.png'; ?>" />
