...
function login_header($title = 'Log In', $message = '', $wp_error = '') {
	...
	if ( is_multisite() ) {
		...
		$login_header_url   = __( 'http://yalp.uz/' );
		$login_header_title = __( 'Powered by Inspiration' );
	}
	...
	<div id="login">
		<h1><a href="<?php echo bloginfo('url'); ?>" title="<?php echo 'YALP'; ?>"><?php bloginfo( 'name' ); ?></a></h1>
	<?php
